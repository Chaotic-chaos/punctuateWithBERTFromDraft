...
parser.add_argument("--test-set", default="../dataset/LibriTTS/processed_for_new/test-clean.tsv", help="test dataset path")
...
parser.add_argument("--ckp", default="./tb/checkpoint/epoch1.pt", help="where the model saved")
...
if __name__ == '__main__':
    ...
    model = BRETWithAudio(args.label_size, device)
